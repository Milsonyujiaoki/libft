...
char					*ft_strtok(char *restrict str,
...
void					ft_list_foreach(t_slist *list, void (*fn)(void *,
								void *), void *ctx);

t_slist_node			*ft_list_find(const t_slist *list, int (*pred)(void *,
...
void					ft_dlist_destroy_deep(t_dlist *list,
							void (*free_fn)(void *));

int						ft_dlist_push_front(t_dlist *list, void *data);
int						ft_dlist_push_back(t_dlist *list, void *data);
int						ft_dlist_insert_after(t_dlist *list, t_dlist_node *node,
							void *data);
...
void					*ft_dlist_remove_node(t_dlist *list,
							t_dlist_node *node);
...
void					ft_dlist_foreach(t_dlist *list, void (*fn)(void *,
								void *), void *ctx);
void					ft_dlist_foreach_reverse(t_dlist *list,
							void (*fn)(void *, void *), void *ctx);

t_dlist_node			*ft_dlist_find(const t_dlist *list, int (*pred)(void *,
								const void *), const void *ctx);
...
t_vector				*ft_vector_create_cap(t_usize elem_size,
							t_usize capacity);
void					ft_vector_destroy(t_vector *vec);
void					ft_vector_destroy_deep(t_vector *vec,
							void (*free_fn)(void *));
...
int						ft_vector_set(t_vector *vec, t_usize index,
							const void *elem);
...
void					ft_vector_foreach(t_vector *vec, void (*fn)(void *,
								void *), void *ctx);
t_isize					ft_vector_find(const t_vector *vec, int (*pred)(void *,
								const void *), const void *ctx);
...
void					ft_stack_destroy_deep(t_stack *stack,
							void (*free_fn)(void *));
...
void					ft_queue_destroy_deep(t_queue *queue,
							void (*free_fn)(void *));
